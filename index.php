        ...
        <div class="wrapper">
            ...
            <header class="main-header">
                ...
                <a href="#" class="logo">
                    ...
                    <span class="logo-lg"><img src="imag/logo_big.png" alt="lg" style="height: 57px;"></span>  
                </a>
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="treeview">
                            ...
                            <ul class="treeview-menu">
                                <li><a href='vista/usuario/anexo.php'><i class='fa fa-phone'></i>Anexo</a></li> 
                                <li><a href='vista/usuario/funcionario.php'><i class='fa fa-user'></i>Funcionario</a></li> 
                ...
                <div id='contenido'>
                    ...
                    <center>
                        <div class="col-md-4 col-sm-5 col-xs-12">
                            <div class="info-box">
                                <span class="info-box-icon bg-blue"><a href="vista/usuario/Menu_Bus.php"><i class="fa fa-search" style="padding-top: 20px;"></i></a></span>
                                <div class="info-box-content" style="padding-top: 20px;">
                                    <a href="vista/usuario/Menu_Bus.php"><span class="info-box-text">BUSCA TU ANEXO AQUI</span></a>
                                    <span class="info-box-number"><a href="vista/usuario/Menu_Bus.php"><i class="fa fa-search" style="padding-top: 20px;"></i></a></span>
                                </div><!-- /.info-box-content -->
                            </div><!-- /.info-box -->
                        </div>
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <div class="info-box">
                                <span class="info-box-icon bg-aqua"><i class="fa fa-desktop" style="padding-top: 20px;"></i></span>
                                <div class="info-box-content" style="padding-top: 20px;">
                                    <span class="info-box-text">TU DIRECCIÓN IP ES</span>
                        ...
                        <div class="col-md-4 col-sm-6 col-xs-12">
                            <div class="info-box">
                                <span class="info-box-icon bg-orange"><i class="fa fa-ticket" style="padding-top: 20px;"></i></span>
                                <div class="info-box-content" style="padding-top: 20px;">
                                    <span class="info-box-text">NECESITAS AYUDA?</span>
                                    <span class="info-box-more"><a href="http://soporte.saludcormun.cl/front/helpdesk.public.php?create_ticket=1">Click aca</a></span>
                                </div><!-- /.info-box-content -->
                            </div><!-- /.info-box -->
                        </div>
