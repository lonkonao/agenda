                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="active treeview">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <?php
                                if ($e == 1) {
                                    echo"<li><a href = '#'><i class = 'fa fa-gears'></i>General</a></li>";
                ...
                <div id='contenido'>
                        ...
                        <div class="col-md-8">
                            <div class="box box-warning collapsed-box">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Creador de Estamentos</h3>
                                ...
                                <div class="box-body">
                                    <div class="col-xs-6">
                                        <form class="form-horizontal" method="POST" action="../../controlador/ControEstamento.php">
                                            <div class="box-body">
                                                <div class="form-group">
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control" name="txtEstamento" placeholder="Estamento">
                                                    </div>
                                                </div>
                    ...
                    <div class="row" style="margin-left: 20px;margin-top:10px">
                        <div class="col-md-8">
                            <div class="box box-warning collapsed-box">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Creador de Sector</h3>
                                    <div class="box-tools pull-right">
                                        <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                                    </div><!-- /.box-tools -->
                                </div><!-- /.box-header -->
                                <div class="box-body">
                                    ...
                                    <div class="col-xs-6">
                                        <!-- form start -->
                                        <form class="form-horizontal" method="POST" action="../../controlador/ControSector.php">
                                            <div class="box-body">
                                                <div class="form-group">
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control" name="txtSector" placeholder="Sector">
                                                    </div>
                                                </div>
                    ...
                    <div class="row" style="margin-left: 20px;margin-top:10px">
                        <div class="col-md-8">
                            <div class="box box-warning collapsed-box">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Creador de Box</h3>
                                    <div class="box-tools pull-right">
                                        <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                                    </div><!-- /.box-tools -->
                                </div><!-- /.box-header -->
                                <div class="box-body">
                                    ...
                                    <div class="col-xs-6">
                                        <!-- form start -->
                                        <form class="form-horizontal" method="POST" action="../../controlador/ControBox.php">
                                            <div class="box-body">
                                                <div class="form-group">
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control" name="txtBox" placeholder="box">
                                                    </div>
                                                </div>
                    ...
                    <div class="row" style="margin-left: 20px;margin-top:10px">
                        <div class="col-md-8">
                            <div class="box box-warning collapsed-box">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Creador de Centro</h3>
                                    <div class="box-tools pull-right">
                                        <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                                    </div><!-- /.box-tools -->
                                </div><!-- /.box-header -->
                    ...
                    <div class="row" style="margin-left: 20px;margin-top:10px">
                        <div class="col-md-8">
                            <div class="box box-warning collapsed-box">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Creador de IP</h3>
                                    <div class="box-tools pull-right">
                                        <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                                    </div><!-- /.box-tools -->
                                </div><!-- /.box-header -->
                                <div class="box-body">
                                    ...
                                    <div class="col-xs-6">
                                        <!-- form start -->
                                        <form class="form-horizontal" method="POST" action="../../controlador/ControIP.php">
                                            <div class="box-body">
                                                <div class="form-group">
                                                    <div class="col-sm-10">
                                                        <input type="text" class="form-control" name="txtIP" placeholder="Direccion IP" maxlength="15">
                                                    </div>
                    ...
                    <div class="row" style="margin-left: 20px;margin-top:10px">
                        <div class="col-md-8">
                            <div class="box box-warning collapsed-box">
                                <div class="box-header with-border">
                                    <h3 class="box-title">Creador de Anexo</h3>
                                    <div class="box-tools pull-right">
                                        <button class="btn btn-box-tool" data-widget="collapse"><i class="fa fa-minus"></i></button>
                                    </div><!-- /.box-tools -->
                                </div><!-- /.box-header -->
