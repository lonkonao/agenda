                                ...
                                <div class="box-body">
                                    <div class="col-xs-4" style="border:1px solid #f4f4f4;">
                                        ...
                                        if (isset($_GET['id'])) {
                                            ...
                                            echo"   <form class = 'form-horizontal' method = 'POST' action = '../../controlador/ControFuncionario_1.php?id=".$id."'>";
                                            ...
                                            echo"  <input type = 'text' class = 'form-control' name = 'txtApellido' value='".$apellido."'>";
                                            echo"  </div>";
                                            echo"  <div class = 'col-sm-10'>";
                                            echo"  <label>Correo Electronico</label>";
                                            echo"  <input type = 'email' class = 'form-control' name = 'txtMail' value='".$mail."'>";
                                            echo"  </div>";
                                            echo"  <div class = 'col-sm-10'>";
