                    ...
                    <div class="row" style="margin-left: 10px;margin-top:10px">
                        <div class="col-md-12" style="width: 99%;">
                            <div class="box box-warning ">
                                ...
                                <div class="box-body">
                                    <div class="col-xs-3" style="border:1px solid #f4f4f4;">
                                        <!-- form start -->
                                        <?php
                                        if (isset($_GET['ip'])) {
                                            $viajando = 1;
                                            ...
                                            $d->comboCentroF($centro);


                                            echo "         </div>";
                                            echo "         <div class='col-sm-10'>";
                                            echo "       <label>Anexo Equipo</label>";
                                            echo "       <input type='number' class='form-control' name='txtAnexo' value='" . $anexo . "'>";
                                            echo "   </div>";
                                            echo "   <div class='col-sm-10'>";
